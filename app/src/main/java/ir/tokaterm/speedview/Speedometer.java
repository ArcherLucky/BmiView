...
abstract public class Speedometer extends View {
    ...
    private float speedTextSize = dpTOpx(0f);
    private float textSize = dpTOpx(14f);
    private String unit = "";
    ...
    private int indicatorColor = Color.RED
            ...
            , lowSpeedColor = Color.YELLOW
            , mediumSpeedColor = Color.GREEN
            , medhighSpeedcolor = Color.parseColor("#e25305")
    ...
    protected int MIN_DEGREE = 180, MAX_DEGREE = 180+180;
    /** to rotate indicator */
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        maxSpeed = a.getFloat(R.styleable.Speedometer_maxSpeed,maxSpeed);
     ...
     */
    public void speedPercentTo(float percent) {
    ...
    public int getMedhighSpeedcolor() {
        return medhighSpeedcolor;
    }

    public void setMedhighSpeedcolor(int medhighSpeedcolor) {
        this.medhighSpeedcolor = medhighSpeedcolor;
    }
